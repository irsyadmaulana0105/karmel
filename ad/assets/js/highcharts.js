...
(function () {
    ...
    for (
      ...
      e.push(k),
        b === D[ta]
          ...
          ? (k = Ya(h, l + d * j))
          : !g && (b === D[pa] || b === D[Va])
          ? (k = Ya(h, l, m + d * j * (b === D[pa] ? 1 : 7)))
          : ((k += b * j), b <= D[Ja] && k % D[pa] === i && (f[k] = pa)),
        d++;
    e.push(k);
  ...
  var x,
    ...
    ia = "div",
    T = "none",
    wb = "rgba(192,192,192," + (fa ? 1.0e-6 : 0.002) + ")",
    zb = "millisecond",
    ib = "second",
    Ua = "minute",
    Ja = "hour",
  ...
  O = {
    ...
    global: {
      useUTC: !0,
      canvasToolsURL:
        "http://code.highcharts.com/2.3.2/modules/canvas-tools.js",
      VMLRadialGradientURL:
        "http://code.highcharts.com/2.3.2/gfx/vml-radial-gradient.png",
    },
    chart: {
      borderColor: "#4572A7",
      borderRadius: 5,
  ...
  va.prototype = {
            ...
            if (l && /^(width|height|visibility|x|y|d|transform)$/.test(c))
              for (e = l.length; e--; )
                B(
                  l[e],
                  c,
                  c === "height" ? v(d - (l[e].cutHeight || 0), 0) : d
                );
    ...
    clip: function (a) {
      return this.attr(
        "clip-path",
        a ? "url(" + this.renderer.url + "#" + a.id + ")" : T
      );
    },
            ...
            if (u(j))
              a.isSVG
                ? ((q = Ha
                    ...
                    ? "-o"
                    : ""),
                  (k[q + "-transform"] = k.transform = "rotate(" + j + "deg)"))
                : ((o = j * ab),
                  (r = W(o)),
                  (o = aa(o)),
                  (k.filter = j
  ...
  ra.prototype = {
    ...
    init: function (a, b, c, d) {
      ...
      this.alignedObjects = [];
      this.url =
        (bb || tb) && z.getElementsByTagName("base").length
          ? e.href
              .replace(/#.*?$/, "")
              .replace(/([\('\)])/g, "\\$1")
              .replace(/ /g, "%20")
      ...
      n(c, function (c, d) {
        ...
        n(h, function (c) {
          if (c !== "" || h.length === 1) {
            ...
            f.test(c) &&
              (B(p, "onclick", 'location.href="' + c.match(f)[1] + '"'),
              G(p, { cursor: "pointer" }));
            c = (c.replace(/<(.|\n)*?>/g, "") || " ")
              .replace(/&lt;/g, "<")
              .replace(/&gt;/g, ">");
            ...
            if (!ea) {
              if (d) {
                ...
                q =
                  L.getComputedStyle &&
                  A(
                    L.getComputedStyle(k, null).getPropertyValue("line-height")
                  );
                if (!q || isNaN(q)) {
                  var n;
                  if (!(n = j))
                    if (!(n = k.offsetHeight))
                      (l[d] = b.getBBox
                        ? b.getBBox().height
                        : a.renderer.fontMetrics(b.style.fontSize).h),
                        (n = t(l[d] - (l[d - 1] || 0)) || 18);
                  q = n;
                }
                B(p, "dy", q);
                  ...
                  !m || c.length === 1
                    ? ((c = I),
                      ...
                      c.length &&
                        ...
                        b.appendChild(p),
                        n > i && (i = n)))
                    : (p.removeChild(p.firstChild), I.unshift(c.pop())),
                  c.length &&
                    p.appendChild(
                      z.createTextNode(c.join(" ").replace(/- /g, "-"))
                    );
          }
        });
      });
    ...
    symbol: function (a, b, c, d, e, f) {
      ...
      h
        ? ((g = this.path(h)),
          s(g, { symbolName: a, x: b, y: c, width: d, height: e }),
          f && s(g, f))
        : i.test(a) &&
          ((k = function (a, b) {
    ...
    color: function (a, b, c) {
      ...
      if (g) {
        ...
        if (!c.id || !h[c.id])
          Fa(c) &&
            ...
            n(a.stops, function (a) {
              f.test(a[1])
                ? ((e = qa(a[1])), (j = e.get("rgb")), (k = e.get("a")))
                : ((j = a[1]), (k = 1));
              a = d
                .createElement("stop")
        ...
        return f.test(a)
          ? ((e = qa(a)), B(b, c + "-opacity", e.get("a")), e.get("rgb"))
    ...
    text: function (a, b, c, d) {
      ...
      !fa && this.forExport && a.css({ position: "absolute" });
      a.x = b;
      a.y = c;
      return a;
    },
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      ...
      g.text = function (a, b) {
        ...
        c = r.element.style;
        q =
          (Da === void 0 || w === void 0 || o.styles.textAlign) && r.getBBox();
        ...
        if (!p)
          (c = h ? -Ea : 0),
            (o.box = p =
              d
                ? m.symbol(d, -y * M, c, o.width, o.height)
                : m.rect(-y * M, c, o.width, o.height, 0, fb["stroke-width"])),
            p.add(o);
    ...
    var ha = {
      ...
      color: function (a, b, c, d) {
        ...
        if (i) {
          ...
          n(a, function (a, b) {
            g.test(a[1])
              ? ((f = qa(a[1])), (k = f.get("rgb")), (l = f.get("a")))
              : ((k = a[1]), (l = 1));
            w.push(a[0] * 100 + "% " + k);
            b ? ((p = l), (q = k)) : ((r = l), (y = k));
          });
            ...
            if (i === "gradient")
              ...
              var j = m.r,
                ...
                j = function () {
                  v &&
                    ((x = d.getBBox()),
                    (t += (v[0] - x.x) / x.width - 0.5),
                    (s += (v[1] - x.y) / x.height - 0.5),
                    (J *= v[2] / x.width),
                    (Q *= v[2] / x.height));
                  M =
                    'src="' +
        ...
        u === "inside" && (q = -q),
          ...
          m
            ...
            : (this.mark = e
                ...
                .add(c.axisGroup));
      if (h && !isNaN(Q))
        (h.xy = J = this.getLabelPosition(Q, J, h, f, j, I, a, t)),
          (this.isFirst && !p(d.showFirstLabel, 1)) ||
          (this.isLast && !p(d.showLastLabel, 1))
            ? (w = !1)
            : !v &&
              f &&
              j.overflow === "justify" &&
  ...
  nb.prototype = {
    render: function () {
      ...
      if (o)
        r
          ? o.animate({ d: r }, null, o.onGetPath)
          : (o.hide(),
  ...
  ob.prototype = {
    ...
    setOptions: function (a) {
      this.options = C(
        ...
        C(O[this.isXAxis ? "xAxis" : "yAxis"], a)
      );
    },
        ...
        if (g.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            if (((h = g.xData), h.length))
              (a.dataMin = P(p(a.dataMin, h[0]), Ma(h))),
                ...
                q !== null &&
                  ...
                  (i
                    ? ((J = (I = q < y) ? k : j),
                      ...
                      c[Q] || (c[Q] = {}),
                      c[Q][n] ||
                        (c[Q][n] = new Hb(a, a.options.stackLabels, I, n, m)),
                      c[Q][n].setTotal(q))
                    : A && (q = g.modifyValue(q)),
                  C ||
                    ((h[f + 1] || n) >= Ea.min && (h[f - 1] || n) <= Ea.max)))
              )
                if ((n = q.length))
                  for (; n--; ) q[n] !== null && (s[w++] = q[n]);
                else s[w++] = q;
            if (!a.usePercentage && s.length)
              (a.dataMin = P(p(a.dataMin, s[0]), Ma(s))),
    ...
    getLinearTickPositions: function (a, b, c) {
      for (
        var d, b = ja(V(b / a) * a), c = ja(wa(c / a) * a), e = [];
        b <= c;
    ...
    setAxisTranslation: function () {
      ...
      if (this.isXAxis)
        this.isLinked
          ? (d = this.linkedParent.minPointOffset)
          : n(this.series, function (a) {
              var f = a.pointRange,
    ...
    setTickPositions: function (a) {
      ...
      if (e)
        !a && P(b.min, p(b.dataMin, b.min)) <= 0 && $a(10, 1),
          (b.min = ja(na(b.min))),
          (b.max = ja(na(b.max)));
      if (
        b.range &&
      ...
      b.tickInterval =
        b.min === b.max || b.min === void 0 || b.max === void 0
          ? 1
          : h && !l && o === b.linkedParent.options.tickPixelInterval
          ? b.linkedParent.tickInterval
          : p(l, r ? 1 : ((b.max - b.min) * o) / (b.len || 1));
      g &&
        !a &&
    ...
    render: function () {
      var a = this,
        ...
        p = d.lineWidth,
        q,
        y = b.hasRendered && u(a.oldMin) && !isNaN(a.oldMin),
        t = a.showAxis,
        s,
        w;
      if (a.hasData || f)
      ...
      if (p)
        (q = a.getLinePath(p)),
          a.axisLine
            ...
            : (a.axisLine = c
                .path(q)
                .attr({ stroke: d.lineColor, "stroke-width": p, zIndex: 7 })
                .add(a.axisGroup)),
      ...
      if (o) {
        ...
        for (e = o.length; e--; )
          if (((i = a.series[e ? "yAxis" : "xAxis"]), o[e] && i))
            if (
              ((i = i.getPlotLinePath(e ? p(a.stackY, a.y) : a.x, 1)),
              this.crosshairs[e])
            )
  ...
  qb.prototype = {
    ...
    setDOMEvents: function () {
      ...
      d.onclick = function (a) {
        ...
        a.cancelBubble = !0;
        if (!c.cancelClick)
          d && (B(a.target, "isTracker") || B(a.target.parentNode, "isTracker"))
            ? ((e = d.plotX),
              (f = d.plotY),
              s(d, {
                pageX:
              ...
              E(d.series, "click", s(a, { point: d })),
              d.firePointEvent("click", a))
            : (s(a, b.getMouseCoordinates(a)),
  ...
  rb.prototype = {
    ...
    renderItem: function (a) {
      ...
      d = n.getBBox();
      (q = a.legendItemWidth =
        e.itemWidth || g + h + d.width + k + (t ? 20 : 0)),
        (e = q);
  ...
  sb.prototype = {
    ...
    cloneRenderTo: function (a) {
      var b = this.renderToClone,
        c = this.container;
      a
        ? b && (this.renderTo.appendChild(c), Na(b), delete this.renderToClone)
    ...
    drawChartBox: function () {
      ...
      u
        ? u.animate({ width: w.width, height: w.height })
        : (this.clipRect = b.clipRect(w));
      if (m)
        g
          ? g.animate(g.crisp(null, p, n, q, y))
          : (this.plotBorder = b
              .rect(p, n, q, y, 0, m)
    ...
    destroy: function () {
      ...
      if (a !== null) {
        ...
        if (d) (d.innerHTML = ""), U(d), f && Na(d), (d = null);
        for (e in a) delete a[e];
        a = a.options = null;
      }
    },
            ...
            (e = h.radius),
              j
                ...
                : (d.stateMarkerGraphic = j =
                    k.renderer
                      .symbol(d.symbol, b - e, c - e, 2 * e, 2 * e)
                      .attr(l[a])
                      .add(d.markerGroup));
  ...
  R.prototype = {
    ...
    generatePoints: function () {
      ...
      for (m = 0; m < g; m++)
        (i = h + m),
          j
            ? (l[m] = new f().init(this, [d[m]].concat(oa(e[m]))))
            : (b[i]
                ? (k = b[i])
                : a[i] !== x && (b[i] = k = new f().init(this, a[i], d[m])),
              (l[m] = k));
      if (b && (g !== (c = b.length) || j))
        for (m = 0; m < c; m++)
          if ((m === h && !j && (m += g), b[m]))
    ...
    translate: function () {
      ...
      for (l = 0; l < h; l++) {
        ...
        k.plotY =
          typeof n === "number" ? t(f.translate(n, 0, 1, 0, 1) * 10) / 10 : x;
    ...
    drawDataLabels: function () {
      ...
      if (c.enabled || a._hasPointLabels) {
        var d,
          ...
          w = v.b;
        s &&
          ((v = { top: w, middle: w - A / 2, bottom: -A + w }),
          r
            ? (q && (c = C(c, { verticalAlign: "middle" })),
        ...
        n(f, function (f) {
          ...
          if ((v = c.enabled))
            (n = (f.barX && f.barX + f.barW / 2) || p(f.plotX, -999)),
              (q = p(f.plotY, -999)),
          ...
          if (B && !v) f.dataLabel = B.destroy();
            ...
            if (B) B.attr({ text: i }).animate({ x: d, y: e });
              ...
              B = f.dataLabel = l[c.rotation ? "text" : "label"](
                i,
                d,
                e,
                null,
    ...
    setVisible: function (a, b) {
      ...
      if (f) f[i]();
        ...
        for (e = j.length; e--; ) if (((f = j[e]), f.tracker)) f.tracker[i]();
      if (g) g[i]();
  ...
  ha = da(R, {
    ...
    getPointSpline: function (a, b, c) {
      ...
      if (f && g) {
        ...
        i > a && i > e
          ? ((i = v(a, e)), (k = 2 * e - i))
          : i < a && i < e && ((i = P(a, e)), (k = 2 * e - i));
        k > g && k > e
          ? ((k = v(g, e)), (i = 2 * e - k))
          : k < g && k < e && ((k = P(g, e)), (i = 2 * e - k));
        b.rightContX = j;
        b.rightContY = k;
      }
      c
      ...
      c.grouping === !1
        ...
        : n(b.series, function (b) {
            ...
            if (b.type === a.type && b.visible && a.options.group === c.group)
              c.stacking
                ? ((j = b.stackKey), i[j] === x && (i[j] = f++), (k = i[j]))
                : c.grouping !== !1 && (k = f++),
                (b.columnIndex = k);
          });
      var l = a.points,
        ...
        B =
          t +
          (m + ((h ? f - a.columnIndex : a.columnIndex) || 0) * o - g / 2) *
            (h ? -1 : 1),
  ...
  X = {
    ...
    translate: function () {
      ...
      n(k, function (c) {
        ...
        j = (i + h) / 2;
        c.slicedTranslation = Sa(
          [W(j) * d + g.plotLeft, aa(j) * d + g.plotTop],
          t
        );
        o = (W(j) * f[2]) / 2;
        p = (aa(j) * f[2]) / 2;
        ...
        e
          ...
          : (j.graphic = e =
              c
                ...
                .attr(s(j.pointAttr[""], { "stroke-linejoin": "round" }))
                .add(j.group)
                .shadow(g, h));
          ...
          for (w = 0; w < C; w++) {
            ...
            if (j > 0) {
              if (
                ...
                (z = q.i),
                (q = q.y),
                (s > q && x[z + 1] !== null) || (s < q && x[z - 1] !== null))
              )
                q = s;
            } else q = s;
            s = d.justify
              ? k[0] + (v ? -1 : 1) * (l + j)
              : this.getX(z === 0 || z === x.length - 1 ? s : q, v);
            g.attr({ visibility: t, align: h[6] })[
              g.moved ? "animate" : "attr"
            ]({ x: s + d.x + ({ left: e, right: -e }[h[6]] || 0), y: q + d.y });
            g.moved = !0;
            if (o && f)
              (g = b.connector),
                (h = i
