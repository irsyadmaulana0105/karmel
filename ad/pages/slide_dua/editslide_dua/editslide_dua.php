...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM slides_dua WHERE id = $id";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($new_image["size"] > 0) {
                ...
                if (move_uploaded_file($new_image["tmp_name"], $target_file)) {
                    ...
                    $sql_update = "UPDATE slides_dua SET image_path='$new_image_path', title='$new_title', subtitle='$new_subtitle', description='$new_description' WHERE id=$id";
                ...
                $sql_update = "UPDATE slides_dua SET title='$new_title', subtitle='$new_subtitle', description='$new_description' WHERE id=$id";
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="?q=editslide_dua&id=<?php echo $row['id']; ?>" method="POST" enctype="multipart/form-data">
