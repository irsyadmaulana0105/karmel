...
<div class="container-fluid service py-5">
    <div class="container py-5">
        ...
        if ($conn) {
            ...
            if (!isset($_SESSION['tempat_wisata'])) {
                $_SESSION['tempat_wisata'] = $tempatWisata;
            }
        ?>
            ...
            <div class="col-12 text-center wow fadeInUp mt-5" data-wow-delay="0.2s">
                <a class="btn btn-primary rounded-pill text-white py-3 px-5" href="?q=rekom">Lihat Rekomendasi Tempat
                    Wisata
                    ..</a>
            </div>
        <?php
            ...
            <div class="testimonial-item">
                <div class="testimonial-inner p-5">
                    <div class="testimonial-inner-img mb-4">
                        <img src="img/logo bitung.png" class="img-fluid rounded-circle" alt="">
                    </div>
